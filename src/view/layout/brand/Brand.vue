...
import LayoutBrand from "@/assets/js/layout/base/brand.js";
import LayoutAsideToggle from "@/assets/js/layout/base/aside-toggle.js";

export default {
  name: "KTBrand",
  mounted() {
    // Init Brand Panel For Logo
    LayoutBrand.init(this.$refs["kt_brand"]);

    // Init Aside Menu Toggle
    LayoutAsideToggle.init(this.$refs["kt_aside_toggle"]);
  },
  methods: {
    siteLogo() {
